...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Eventify Support Team",
            "email": "support@eventify.local"
        },
        "license": {
            "name": "MIT",
    ...
    "paths": {
        ...
        "/api/v1/admin/events": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter status (draft, published, completed, cancelled)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "allOf": [
                                                {
                                                    "$ref": "#/definitions/utils.PaginatedData"
                                                },
                                                {
                                                    "type": "object",
                                                    "properties": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateEventStatusRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/events": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search name, location, or description",
                        "name": "search",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/orders": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Quota exceeded or invalid input",
                        "schema": {
                            "$ref": "#/definitions/utils.APIResponse"
                        }
                    },
        ...
        "/api/v1/orders/{code}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Order Code (e.g. ORD-20260909-XXXX)",
                        "name": "code",
                        "in": "path",
                        "required": true
                    }
        ...
        "/api/v1/organizer/events/{id}/banner": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/organizer/my-events": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Organizer events retrieved",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.APIResponse"
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateTicketTierRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.TicketTierResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/organizer/ticket-tiers/{id}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update Ticket Tier Body",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateTicketTierRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/payments/webhook": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Xendit Callback Token or Dev Secret",
        ...
        "/api/v1/scanner/check-in": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Ticket invalid or already checked in",
                        "schema": {
                            "$ref": "#/definitions/utils.APIResponse"
                        }
                    },
        ...
        "/api/v1/tickets/{code}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Ticket Code (e.g. EVT-TK-1A2B3C4D5E6F)",
                        "name": "code",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "dto.CreateEventRequest": {
            ...
            "properties": {
                "description": {
                    "type": "string",
                    "example": "Biggest tech summit in Indonesia"
                },
                "end_at": {
                    "type": "string",
                ...
                "terms_conditions": {
                    "type": "string",
                    "example": "Tickets are non-refundable."
                },
                "ticket_tiers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.CreateTicketTierChild"
                    }
                }
            }
        },
        ...
        "dto.CreateTicketTierRequest": {
            ...
            "properties": {
                "description": {
                    "type": "string",
                    "example": "Free snacks and front row seat"
                },
                "end_sale_at": {
                    "type": "string"
                },
        ...
        "dto.UpdateEventRequest": {
            ...
            "properties": {
                ...
                "end_at": {
                    "type": "string",
                    "example": "2026-11-01T17:00:00Z"
                },
                "location": {
                    "type": "string",
                    "maxLength": 255,
                    "example": "Bali Nusa Dua"
                },
                "name": {
                    "type": "string",
                    "maxLength": 200,
